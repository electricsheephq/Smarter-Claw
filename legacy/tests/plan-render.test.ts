/**
 * Ported from openclaw-1: src/agents/plan-render.test.ts
 */
...
describe("mention neutralization", () => {
  ...
  it("plaintext renderPlanWithHeader: neutralizes @everyone in TITLE", () => {
  ...
  it("markdown: neutralizes @channel/@here/@everyone in step text", () => {
    const steps: PlanStepForRender[] = [
      { step: "Notify @channel about deploy", status: "pending" },
      { step: "@here review needed", status: "pending" },
      { step: "@everyone please respond", status: "pending" },
  ...
  it("markdown: neutralizes Discord raw mentions <@123> / <@!123> / <@&123>", () => {
    const steps: PlanStepForRender[] = [
  ...
  it("html: neutralizes @channel/@here/@everyone in step text", () => {
    const steps: PlanStepForRender[] = [
      { step: "Notify @channel about deploy", status: "pending" },
      { step: "@everyone please respond", status: "pending" },
    ];
  ...
  it("markdown renderPlanWithHeader: neutralizes @everyone in TITLE", () => {
    const steps: PlanStepForRender[] = [{ step: "Tag release", status: "pending" }];
...
describe("HTML escaping", () => {
  ...
  describe("closure-gate criteria rendering", () => {
    ...
    it("markdown: renders verified as [x] and unverified as [ ] under the step", () => {
      ...
      expect(out).toContain("- [ ] cortex\\_owner is set");
    });
...
describe("renderFullPlanArchetypeMarkdown", () => {
  ...
  it("preserves analysis paragraph breaks", () => {
    const out = renderFullPlanArchetypeMarkdown({
      title: "Para test",
  ...
  it("neutralizes mention bombs in title + analysis", () => {
    const out = renderFullPlanArchetypeMarkdown({
