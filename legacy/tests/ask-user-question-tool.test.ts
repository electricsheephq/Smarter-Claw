/**
 * Ported from openclaw-1: src/agents/tools/ask-user-question-tool.test.ts
 *
 * Note: ToolInputError is imported from `../src/tool-helpers.js` (the
 * Smarter-Claw export) instead of `./common.js` (the openclaw-1 path).
 */
import { describe, expect, test } from "vitest";
import { createAskUserQuestionTool } from "../src/tools/ask-user-question-tool.js";
import { ToolInputError } from "../src/tool-helpers.js";
