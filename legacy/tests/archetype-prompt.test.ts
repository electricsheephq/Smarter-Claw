/**
 * Ported from openclaw-1: src/agents/plan-mode/plan-archetype-prompt.test.ts
 *
 * Tests for plan-archetype prompt fragment + filename helpers.
 */
